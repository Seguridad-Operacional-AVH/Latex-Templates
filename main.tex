...
\begin{document}
	...
	\begin{table}[H]
		...
		\begin{tabular}{p{5cm} p{9.5cm}}
			...
			\begin{itemize}
				...
				\item \texttt{FLIGHT\_\_PHASE}
			\end{itemize}
			Adicionalmente, la evaluación se restringe a las fases \textit{FIN\_APPROACH} y \textit{LANDING}, y se habilita únicamente cuando se identifica una variación relevante por debajo del establecido para los Thrust Levers de \SI{15}{\degree}). \\
			\hline
			\textbf{Lógica de activación} &
	...
	Se elimina el High Trigger del evento 5412 - Late Thrust Reduction LDG. 
\end{document}